...
<div id="bodier_page">
    <div id="content">
       <div class="sponsor">
    	<div class="page_heading">SoundKILDA Entry Form</div>
        ...
        <div id="form-container">
          <form name="soundForm" id="soundForm" method="post" action="<?=base_url()?>apply_form">
             <div class="form-row">
                ...
                <div class="row-input">
                  <input type="text" name="Song title" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Artist band" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                 ...
                 &nbsp;
                 Year&nbsp;&nbsp;<input type="text" name="Year Completed" style="width:153px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                 <input type="text" name="Film running mins" style="width:65px;"/>
                 &nbsp;&nbsp;Mins&nbsp;&nbsp;
                 <input type="text" name="Film running seconds" style="width:65px;"/>&nbsp;&nbsp;Seconds
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
             ...
             <p>&nbsp;</p>
             <p>Please note: Selected films may be compiled to one <br/>Digibeta by the Festival for the SoundKILDA <br/>screening session.</p><br/>
             ...
             <div class="form-row">
                ...
                <div class="row-input">
                 <input type="text" name="Video Link" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                 <input type="text" name="Account Password" style="width:261px;"/>
                </div>
             </div>
             <p>*please note, this is not for us to download the film, <br>
             but to watch via Vimeo or YoutTube</p>
            <p>&nbsp;</p>
             <!-- end new film field --> 
             
             
             <p><span class="page_boldheading">FILM DETAILS</span></p>
                <p>&nbsp;</p>
              <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Producer" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Director" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Screenwriter" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Director of Photography" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Production Designer" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Sound Recordist" style="width:261px;"/>
                </div>
             </div>
            <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Editor" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Post Prod Sound/Sound Design" style="width:261px;"/>
                </div>
             </div>
              <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Visual Effects" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Animator" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Other Key Crew" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal Cast" style="width:261px;"/>
                </div>
             </div>
             ...
             <div class="form-row" style="margin-top:12px">
                ...
                <p class="information_text">(Must not exceed 25 words. The Festival reserves the right <br/>to edit publicity for the printed program).
             ...
             <div class="form-row" style="margin-top:12px">
                <div class="row-title">
                   If yes,please state the name of the educational institution
                </div>
                <div class="row-input">
                  <input type="text" name="education institution" style="width:261px;"/>
             ...
             <div class="form-row">
               ...
               <p>&nbsp;</p>
             <p class="page_boldheading"><strong>PRINCIPAL CONTACT DETAILS</strong></p>
                <p>&nbsp;</p>
              ...
              <div class="form-row">
                ...
                <div class="row-input">
                  <input type="text" name="Principal first name" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal last name" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal position" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal production company" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal address" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal suburb" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
             ...
             <div class="form-row">
                ...
                <div class="row-input">
                  <input type="text" name="Principal postcode" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Telephone business hours" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Telephone after hours" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal mobile" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="Principal fax" style="width:261px;"/>
                </div>
             </div>
              <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="email private" style="width:261px;"/>
                </div>
             </div>
              <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="email public" style="width:261px;"/>
                </div>
             </div>
             <p>&nbsp;</p>
             <p class="page_boldheading"><strong>SCREENING INFORMATION</strong></p><br/>
             <p>If your film is selected for inclusion into the Festival, you will be required to provide a screening copy. To ensure your entry is screened correctly, please provide the following information.</p><br/>
              <div class="form-row">
                <div class="row-title">
                 Screening ratio<span class="required">*</span>
                </div>
                <div class="row-input">
                 <select style="width:265px;" name="Screening ratio" id="screening_ratio" onchange="ratio_other()">
              ...
              <div class="form-row">
                <div class="row-title">
                 Delivery format<span class="required">*</span><br/>
                </div>
                <div class="row-input">
             ...
             <div class="form-row">
              ...
              <div style="margin-top:5px">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr valign="top" height="30"><td valign="top"><input type="radio" name="Audio specifications" value="Stereo" /></td>
                      ...
                      <td valign="top">Stereo <i>(A Mix with only Left and Right information - L/R)</i><br/></td>
                  </tr>
              ...
              <?php } ?>
             <br/>
             <p class="page_boldheading"><strong>RETURN ADDRESS DETAILS</strong></p>
                <p>&nbsp;</p>
             <div class="form-row">
                <div class="row-title">
                  Address<span class="required">*</span>
                ...
                <div class="row-input">
                  <input type="text" name="return address" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
                ...
                <div class="row-input">
                  <input type="text" name="return suburb" style="width:261px;"/>
                </div>
             </div>
             <div class="form-row">
                <div class="row-title">
              ...
              <div class="form-row">
                ...
                <div class="row-input">
                  <input type="text" name="return postcode" style="width:261px;"/>
                </div>
             </div>
               <p>&nbsp;</p>
...
Entries MUST be postmarked or received by 5pm, January 30, 2015
             ...
             <p class="page_boldheading"><strong>PAYMENT OPTIONS</strong></p>
                ...
                <p><input type="radio" name="payment_option" value="credit card" />&nbsp;&nbsp;Credit Card</p> <p>&nbsp;</p>
                 ...
                 <p>By submitting this entry form you are certifying that you have read and agree to the <a style="color:#0ff" target="_blank" href="<?=base_url()?>page-118/soundkilda---terms-conditions">terms and conditions</a> of entry.</p><p>&nbsp;</p>
